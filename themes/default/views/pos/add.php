                            ...
                            <div id="left-bottom">
                                ...
                                <div id="botbuttons" class="col-xs-12 text-center">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-4" style="padding: 0;">
                                            <button type="button" class="btn btn-success btn-block payment" id="payment" style="height:67px;">
            ...
            <div class="modal-body" id="payment_content">
                <div class="row">
                    <div class="col-md-10 col-sm-9">
						...
						<div class="payment-cash" style="font-size:16px;">
							...
							<table class="table table-bordered table-condensed table-striped">
								<tbody>									
									...
									<tr>
										<td width="50%" height="45" class="text-left bold"><?= lang("total_items"); ?></td>
										<?php
											foreach ($allCurrencies as $currency)
											{
										?>
									...
									<tr>
										<td width="50%" height="45" class="text-left bold"><?= lang("total_payable"); ?></td>									
										<?php
											foreach ($allCurrencies as $currency)
											{
										?>
												<td class="text-right"><span class="total_payable" rate="<?=$currency->rate?>" id="total_payable">0</span></td>
										<?php
											}
										?>
									</tr>
									<tr>
										<td width="50%" height="45" class="text-left bold"><?= lang("paid_amount"); ?></td>									
										<?php
											foreach ($allCurrencies as $currency)
											{
										?>
												<td class="text-right">
													<input name="camount[]" rate="<?=$currency->rate?>" type="text" class="form-control camount" class="text-right"/>												
												</td>
										<?php
											}
										?>
									...
									<tr>
										...
										<?php
											...
											{
										?>
												<td class="text-right"><span class="balance_1" rate="<?=$currency->rate?>" id="balance_1">0</span></td>
										<?php
											}
										?>
									</tr>
...
<?php if ($this->input->get('customer')) {?>
		...
		/************Updated Currencies***************/
			...
			$(".payment").on("click",function(){
				var total = $("#total").text()-0, amount_1 = $("#amount_1").val();
				$(".total_payable").each(function(){
					var rate = $(this).attr("rate") - 0;
					var payable = total * rate;
					$(this).text(formatDecimal(payable));
				});	
				...
				$(".camount").on("keyup",function(){
					...
					$(".balance_1").each(function(){											
						var rate = $(this).attr("rate")-0;
						var balance_1 = (tamount - total) * rate;
						$(this).text(formatDecimal(balance_1));
						i++;
					});
					
					$("#amount_1").val(formatDecimal(tamount)).trigger("focus keyup keypress");
					$('#amount_val_1').val(formatDecimal(tamount));
					calculateTotals();
				});	
