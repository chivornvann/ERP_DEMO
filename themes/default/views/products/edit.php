										...
										foreach($product_unit as $productunit_row){
											echo'<tr>
													...
													<td><input type="hidden" name="product_unit_id[]" value="'.$productunit_row->id.'"/>
														<input class="form-control" name="product_unit_qty[]" placeholder="'.lang('quantity').'" type="text" value="'.$productunit_row->unit_qty.'"/>
													</td>
												</tr>';
										}
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function () {
							...
							product_unit += '<td><input type="hidden" name="product_unit_id[]" value="'+this.id+'"/><input class="form-control" name="product_unit_qty[]" placeholder="<?= lang('quantity') ?>" type="text" value="'+this.operation_value+'"/></td></tr>';							
