            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-6 col-md-offset-1">
                    <div class="standard">
                        ...
                        <div id="attrs"></div>
                        <div>
                            <div style="display:none" id="box_product_unit" class="table-responsive">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function () {	
							...
							product_unit += '<td><input type="hidden" name="product_unit_id[]" value="'+this.id+'"/><input class="form-control" name="product_unit_qty[]" placeholder="<?= lang('quantity') ?>" type="text" value="'+getNumber(this.operation_value)+'"/></td></tr>';							
