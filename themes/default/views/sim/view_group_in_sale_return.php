...
<script>
    $(document).ready(function () {
        $('#CGData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('sim_sale_returns/getGroupPerReturnRecord/'.$this->uri->segment(3)) ?>',
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a title="<?= lang('add_sim_group') ?>" class="tip" href="<?php echo site_url('sim_sale_returns/addGroupToSaleReturn/').$this->uri->segment(3); ?>" data-toggle="modal" data-target="#myModal">
