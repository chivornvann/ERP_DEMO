...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open("sim_sale_consignments/edit_sale_consignment/" . $id, $attrib); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_sale_consignment', lang('edit_sale_consignment'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
