...
<script>
    $(document).ready(function () {
        $('#CGData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('sim/getSimStockTypes') ?>',
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a title="<?= lang('add_sim_stock_type') ?>" class="tip" href="<?php echo site_url('sim/add_sim_stock_type'); ?>" data-toggle="modal" data-target="#myModal">
