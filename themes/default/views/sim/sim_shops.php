...
<script>
    $(document).ready(function () {
        $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('sim/getSimShops') ?>',
...
<?= form_open('sim/sim_shop_actions', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('sim/add_sim_shop'); ?>" data-toggle="modal"
                               data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_sim_shop') ?></a></li>
                        ...
                        <li><a href="#" id="delete" data-action="delete"><i
                                    class="fa fa-trash-o"></i> <?= lang('delete_sim_shops') ?></a></li>
                    </ul>
                </li>
            </ul>
        </div>
