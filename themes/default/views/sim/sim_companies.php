...
<script>
    $(document).ready(function () {
        $('#CGData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('sim/getSimCompanies') ?>',
...
<?= form_open('sim/sim_company_actions', 'id="action-form"') ?>
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a title="<?= lang('add_sim_company') ?>" class="tip" href="<?php echo site_url('sim/add_sim_company'); ?>" data-toggle="modal" data-target="#myModal">
