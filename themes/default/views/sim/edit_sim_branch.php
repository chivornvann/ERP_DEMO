...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_sim_branch'); ?></h4>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div
                    class="controls"> <?php echo form_input('branch_name', $sim_branches->branch_name, 'class="form-control" id="branch_name" required="required"'); ?> </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div
                    class="controls"> <?php echo form_input('contact_name', $sim_branches->contact_name, 'class="form-control" id="contact_name"'); ?> </div>
            </div>
            <div class="form-group">
                <label class="control-label" for="facebook_name"><?php echo $this->lang->line("facebook_name"); ?></label>

                <div
                    class="controls"> <?php echo form_input('facebook_name', $sim_branches->facebook_name, 'class="form-control" id="facebook_name"'); ?> </div>
            </div>
           
        </div>
        <div class="modal-footer">
            <?php echo form_submit('edit_sim_branch', lang('edit_sim_branch'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
